...
<html>
    ...
    <body>
        <h2 style="margin-top:0px">Hospital Read</h2>
        <table class="table">
	    <tr><td>Nama Hospital</td><td><?php echo $nama_hospital; ?></td></tr>
	    ...
	    <tr><td></td><td><a href="<?php echo site_url('hospital') ?>" class="btn btn-default">Cancel</a></td></tr>
	</table>
        </body>
</html>