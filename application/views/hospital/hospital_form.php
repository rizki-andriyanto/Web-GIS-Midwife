...
<html>
    ...
    <body>
	    ...
	    <div class="form-group">
            <label for="varchar">Nama Hospital <?php echo form_error('nama_hospital') ?></label>
            <input type="text" class="form-control" name="nama_hospital" id="nama_hospital" placeholder="Nama Hospital" value="<?php echo $nama_hospital; ?>" />
        </div>
	    <div class="form-group">
