						...
						<div class="inner">
							...
							<!-- Search 1 -->
								...
								<section id="search" class="alt">
									...
									<form action="<?= site_url('peta');?>" method='post'> 
											<select name="keyword">
												
												<option value="rsLayer">Rumah Sakit Bersalin</option>
												<option value="midwifeLayer">Bidan</option>
												<option value="">Semua Objek</option>
											</select>
										</div> 
										<ul class="actions small">
											<li>
												<input type="submit" value="Cari" class="button special small">
											</li>
										</ul>
									</form>
								</section>
								...
								<section id="search" class="alt">
							        ...
							        foreach($groups as $row)
							        	{ 
							          echo 	'<option value="'.$row->name_subdistrict.'">'.$row->name_subdistrict.
							          		'</option>';
							        	}
							        ?>
							        </select>
