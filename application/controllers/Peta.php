...
class Peta extends CI_Controller {
	...
	{	
		// $data1['groups'] = $this->Subdistrict_model1->getAllGroups();
		...
		// $this->load->view('formpencarian',$data);//coba
		$this->load->view('template/peta/legend',$data);
		
		$this->load->view('template/section');
		$this->load->view('template/peta/sidebar',$data);
		// $this->load->view('template/peta/list_midwife',$data);
		// $this->load->view('template/peta/list_subdistrict',$data);
		// $this->load->view('template/peta/list_hospital',$data);
